...
//run("Export results", "filepath=["+WORK+"/result.csv] fileformat=[CSV (comma separated)] id=true frame=false sigma=true bkgstd=true intensity=true saveprotocol=true offset=true uncertainty=true y=true x=true");
close()
run("Quit");